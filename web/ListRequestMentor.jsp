                    ...
                    <div class="table-responsive">
                        ...
                        <div class="filter-container">
                            <form method="POST" action="FilterStatusMentorServlet">
                                ...
                                <label for="menteeNameFilter">Filter by Mentee Name: </label>
                                <select id="menteeNameFilter" name="menteeNameFilter">
                                    <option value="all" ${menteeName == '' ? 'selected' : ''}>All</option>
                                    <c:forEach var="mentee" items="${menteeList}">
                                        <option value="${mentee.userName}" ${menteeName == mentee.userName ? 'selected' : ''}>
                                            ${mentee.userName}
                                        </option>
                                    </c:forEach>
                                </select>
