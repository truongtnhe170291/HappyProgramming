    ...
    <body>
        ...
        <div class="container">
            ...
            <form action="feedback" method="post">
                <div class="rating">
                    <div>Rating</div>
                    <input class="sss" type="radio" id="star1" name="rate" value="1" />
                    ...
                    <input class="sss" value="2" name="rate" id="star2" type="radio" />
                    ...
                    <input class="sss" value="3" name="rate" id="star3" type="radio" />
                    ...
                    <input class="sss" value="4" name="rate" id="star4" type="radio" />
                    <label title="Great!" for="star4">
                        ...
                        <path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"/>
                                    ...
                                    <input type="hidden" name="rating" id="rating" value="${feedbackObj.star}">
                                      ...
                                      <input class="sss" value="5" name="rate" id="star5" type="radio" />
                ...
                <div class="comment-box">
                    ...
                    <div style="display: flex; justify-content: space-between">
                        <button type="button" onclick="document.location.href = 'ListRequest'" class="submit-btn">Back</button>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const feedbackStarValue = parseInt("${feedbackObj.star}");

    if (feedbackStarValue > 0) {
        document.getElementById('star' + feedbackStarValue).checked = true;
        const labels = document.querySelectorAll('.rating label');
        labels.forEach((label, index) => {
            if (index + 1 <= feedbackStarValue) {
