                                                ...
                                                <tbody>
                                                    <c:forEach items="${requestScope.cvList}" var="cv">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input id="note_${cv.cvId}" required name="note"
                                                                    value="" class="userDatatable-content--date"
                                                                    type="text" />
                                                                <form id="form_${cv.cvId}">
                                                                    <input type="hidden" name="cvId"
                                                                        value="${cv.cvId}" />
                                                                    <input id="status_${cv.cvId}" type="hidden"
                                                                        name="status" value="" />
                                                                    <input id="note_Input_${cv.cvId}" type="hidden"
                                                                        name="note" value="" />
