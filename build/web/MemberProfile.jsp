<%-- Document : control_nav Created on : May 18, 2024, 8:56:02 AM Author : 84979 --%>
    ...
    <%@page contentType="text/html" pageEncoding="UTF-8" %>
        ...
        <head>
            ...
            <!-- GOOGLE WEB FONT -->
            <link
                href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,800|Raleway:400,500,600,700,800"
                rel="stylesheet">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade in active" id="profile">
                                    <div class="row">
                                        <form class="form" action="UpdateAccountServlet" method="post"
                                                    ...
                                                    <div class="flext">
                                                        ...
                                                        <label for="file-upload" class="">
                                                            <img id="profile-img"
                                                                ...
                                                                src="./img/${user.avatar}" alt="profile">
