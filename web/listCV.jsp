               ...
               <div class="row">
                  <div class="col-lg-12">
                     ...
                     <div class="breadcrumb-main">
                        <h4 class="text-capitalize breadcrumb-title">Tickets</h4>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <div class="userDatatable-content d-inline-block">
                                             ...
                                             <span class="bg-opacity-danger color-danger userDatatable-content-status">remove</span>
                                             <span class="bg-opacity-warning color-warning userDatatable-content-status">wait</span>
                                          </div>
                                       </td>
                                       <td>
