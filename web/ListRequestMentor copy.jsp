                        ...
                        <c:forEach var="request" items="${requests}">
                            <tr>
                                ...
                                <td class="d-flex" style="margin-top:12px;">
                                   ...
                                   <input type="hidden" name="requestId" value="${request.requestId}" />
                                   <button class="hsd" style="border-radius: 0.42rem 0.42rem 0.42rem 0.42rem;" type="submit">
                                       <li class="checkss">
                                           <a href="#" class="edit">
                               ...
                               <form method="POST" action="reject"
                                   ...
                                   <input type="hidden" name="requestId" value="${request.requestId}" />
                                   <button class="mst" style="border-radius: 0.42rem 0.42rem 0.42rem 0.42rem;" type="submit">
                                       <li class="removeess">
                                           <a href="#" class="remove">
    ...
    statusCells.forEach(cell => {
        ...
        switch (status) {
            ...
            case "Reject":
                ...
                hideButtons(cell.parentElement);
                break;
            case "Processing":
...
function hideButtons(row) {
    const checkBtn = row.querySelector(".hsd");
    const timesBtn = row.querySelector(".mst");

    if (checkBtn) checkBtn.style.display = "none";
    if (timesBtn) timesBtn.style.display = "none";
}
