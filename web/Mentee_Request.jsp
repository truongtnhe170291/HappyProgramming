                                            ...
                                            <div class="row">
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="description" id="notify_message" class="form-control notification-message" placeholder="Type your message here" required="" rows="5">This notification looks so perfect!</textarea>
                                                    </div>
                                                    <div class="form-group">
