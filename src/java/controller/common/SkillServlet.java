...
protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
        ...
        if (searchTerm != null) {
            searchTerm = searchTerm.trim(); // Loại bỏ dấu cách ở đầu và cuối chuỗi
            if (!searchTerm.isEmpty()) {
                ...
                // Nếu từ khóa tìm kiếm chỉ có dấu cách, lấy danh sách kỹ năng theo trang và đếm tổng số kỹ năng
