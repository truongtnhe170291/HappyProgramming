                                        ...
                                        <form method="POST" action="ListRequest">
                                            ...
                                            <div class="action-btn">
                                                <a href="#" class="btn btn-primary align-center centaxs"
                                                    data-bs-toggle="modal" data-bs-target="#ticket_modal"
                                                            ...
                                                            <div class="modal-body pb-sm-50 pb-30">
                                                                ...
                                                                <div class="ticket_modal-modal">
                                                                    <form>
                                                                        ...
                                                                        <c:forEach var="request" items="${requests}">
                                                                            <c:if
                                                                                test="${request.requestId != currentRequestId}">
                                                                                <h2>${request.title}</h2>
                                                                                <p><strong>Mentor Name:</strong>
                                                                                    ${request.mentorName}</p>
                                                                                <p><strong>Mentee Name:</strong>
                                                                                    ${request.menteeName}</p>
                                                                                <p><strong>Description:</strong>
                                                                                    ${request.description}</p>
                                                                                <p><strong>Deadline Date:</strong>
                                                                                    ${request.deadlineDate}</p>
                                                                                <p><strong>Deadline Hour:</strong>
                                                                                    ${request.deadlineHour}</p>

                                                                                <p><strong>Start Time:</strong>
                                                                                    ${request.startTime}</p>
                                                                                <p><strong>End Time:</strong>
                                                                                    ${request.endTime}</p>
                                                                                <p><strong>Status ID:</strong>
                                                                                    ${request.statusId}</p>
                                                                                ...
                                                                                <c:set var="currentRequestId"
                                                                                    value="${request.requestId}" />
                                                                            </c:if>
                                                                            <p><strong>Day of Slot:</strong>
                                                                                ${request.dayOfSlot}</p>
                                                                            <p><strong>Slot Name:</strong>
                                                                                ${request.slotName}</p>
                                                                            <p><strong>Slot ID:</strong>
                                                                                ${request.slotID}</p>
                                                                        </c:forEach>
