...
>>>>>>> ab312de59d801916d53b223789b335dd6bce0118
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill"
                                                    ...
                                                    <img src="img/svg/briefcase.svg" alt="briefcase"
                                                        class="svg">Curriculum Vitae</a>
                                            </li>
                                            <li class="nav-item fl ">

                                                <input value="Send CV" class="nav-link cliick" id="v-pills-profile-tab"
                                                    data-bs-toggle="pill" type="submit" />
                                            </li>
                                                ...
                                                <div class="col-xxl-4 col-10">
                                                    <div class="mt-40 mb-50">
                                                        ...
                                                        <form action="cv" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="account-profile d-flex align-items-center mb-4">
                                                                <div class="ap-img pro_img_wrapper">
                                                                    <input id="file-uploadcv" type="file"
                                                                        name="uploadcv" class="d-none" accept="image/*">
                                                                    <!-- Profile picture image -->
                                                                    <label for="file-uploadcv"
                                                                        class="position-relative d-inline-block">
                                                                        <img id="profile-imgcv"
                                                                            class="ap-img__main rounded-circle wh-120 bg-lighter d-flex"
                                                                            src="./imgcv/${cv.imgcv}" alt="profile">
                                                                        <span class="cross position-absolute"
                                                                            id="remove_pro_pic">
                                                            ...
                                                            <div class="edit-profile__body">
                                                                ...
                                                                <div style="margin-bottom: 15px">
                                                                    <div class="form-group mb-25">
                                                                        ...
                                                                        <input name="fullName" value="${cv.fullName}"
                                                                            type="text" class="form-control"
                                                                            id="fullname2" placeholder="Duran Clayton">
                                                                    </div>
                                                                    <div style="display: none" id="nameError2"
                                                                        class="alert alert-warning alert-dismissible fade show"
                                                                        role="alert">
                                                                        <strong style="color: red">Oh no!</strong> Your
                                                                        name is invalid.
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div style="margin-bottom: 15px">
                                                                    <div class="form-group mb-25">
                                                                        ...
                                                                        <input name="gmail" value="${cv.gmail}"
                                                                            type="text" class="form-control" id="email2"
                                                                            placeholder="Design">
                                                                    </div>
                                                                    <div style="display: none" id="emailError2"
                                                                        class="alert alert-warning alert-dismissible fade show"
                                                                        role="alert">
                                                                        <strong style="color: red">Oh no!</strong> Your
                                                                        email is invalid.
                                                                ...
                                                                <div style="margin-bottom: 15px">
                                                                    <div class="form-group mb-25 form-group">
                                                                        ...
                                                                        <div class="position-relative">
                                                                            <input id="dob2" name="dob"
                                                                                value="${cv.dob}" type="date"
                                                                                class="form-control"
                                                                                placeholder="January 20, 2018">
                                                                        </div>
                                                                    </div>
                                                                    <div style="display: none" id="dobError2"
                                                                        class="alert alert-warning alert-dismissible fade show"
                                                                        role="alert">
                                                                        <strong style="color: red">Oh no!</strong> Your
                                                                ...
                                                                <div style="display: none" id="dobvcErr"
                                                                    class="alert alert-warning alert-dismissible fade show"
                                                                    role="alert">
                                                                    <strong style="color: red">Oh no!</strong> your
                                                                    birthday is invalid.
                                                                    ...
                                                                    <div class="d-flex">
                                                                        <div
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <input name="sex" ${cv.sex ? "checked"
                                                                                    : "" } class="radio" type="radio"
                                                                                    value="1" id="radio-hl1">
                                                                                <label for="radio-hl1">
                                                                            ...
                                                                            <div
                                                                                class="radio-theme-default custom-radio ">
                                                                                <input name="sex" ${cv.sex ? ""
                                                                                    : "checked" } class="radio"
                                                                                    type="radio" value="0"
                                                                                    id="radio-hl2">
                                                                                <label for="radio-hl2">
                                                                                    <span
                                                                                        class="radio-text">Female</span>
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div style="margin-bottom: 15px">
                                                                    ...
                                                                    <div class="form-group mb-25">
                                                                        ...
                                                                        <input name="address" value="${cv.address}"
                                                                            type="text" class="form-control"
                                                                            id="address2" placeholder="Design">
                                                                    </div>
                                                                    <div style="display: none" id="addressError2"
                                                                        class="alert alert-warning alert-dismissible fade show"
                                                                        role="alert">
                                                                ...
                                                                <div class="form-group mb-25">
                                                                    ...
                                                                    <input name="profession" value="${cv.profession}"
                                                                        type="text" class="form-control"
                                                                        id="phoneNumber1" placeholder="Design">
                                                                </div>
                                                                <div class="form-group mb-25">
                                                                    <label for="phoneNumber1">Profession
                                                                        introduction</label>
                                                                    <textarea name="professionIntro" type="text"
                                                                        class="form-control"
...
<<<<<<< HEAD
                                                                <div class="form-group mb-25">
                                                                    <label for="phoneNumber1">Achievement
                                                                        Description</label>
                                                                    <textarea name="achievementDescription" type="text"
                                                                        class="form-control"
                                                                        id="phoneNumber1">${cv.achievementDescription}</textarea>
                                                                </div>

                                                                <div class="form-group mb-25">
                                                                    <label for="phoneNumber1">Service
                                                                        Description</label>
                                                                    <textarea name="serviceDescription" type="text"
                                                                        class="form-control"
                                                                        id="phoneNumber1">${cv.serviceDescription}</textarea>
                                                                </div>

                                                                <div class="form-group mb-25 status-radio ">
                                                                    <label for="hiringDateCheckbox">Skill</label>
                                                                    <div class="d-flex">
                                                                        <c:forEach items="${requestScope.skills}"
                                                                            var="skill">
                                                                            <c:set var="isChecked" value="false" />
                                                                            <c:forEach items="${cv.skills}"
                                                                                var="cvskill">
                                                                                <c:if
                                                                                    test="${skill.skillID == cvskill}">
                                                                                    <c:set var="isChecked"
                                                                                        value="true" />
                                                                                </c:if>
                                                                            </c:forEach>
                                                                            <div class="form-check">
                                                                                <input name="skills"
                                                                                    ...
                                                                                    type="checkbox" <c:if
                                                                                    test="${isChecked}">checked</c:if>
                                                                                value="${skill.skillID}"
                                                                                id="hiringDateCheckbox">
...
>>>>>>> ab312de59d801916d53b223789b335dd6bce0118
                                                                ...
                                                                <div
                                                                    ...
                                                                    <button type="submit" id="submitForm2"
                                                                        class="btn btn-primary btn-default btn-squared text-capitalize radius-md shadow2 btn-sm">SAVE</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
                                                        ...
                                                        <form action="CalendarBookingServlet" method="POST">
                                                            ...
                                                            <div class="edit-profile__body">
                                                                    ...
                                                                    <tbody>
                                                                        <c:forEach items="${slot}" var="s">
                                                                            <tr>
                                                                                ...
                                                                                <td><input type="checkbox"
                                                                                        name="booking"
                                                                                        value="${s.slot_id} + mo"></td>
                                                                                <td><input type="checkbox"
                                                                                        name="booking"
                                                                                        value="${s.slot_id} + tu"></td>
                                                                                <td><input type="checkbox"
                                                                                        name="booking"
                                                                                        value="${s.slot_id} + we"></td>
                                                                                <td><input type="checkbox"
                                                                                        name="booking"
                                                                                        value="${s.slot_id} + th"></td>
                                                                                <td><input type="checkbox"
                                                                                        name="booking"
                                                                                        value="${s.slot_id} + fr"></td>
                                                                                <td><input type="checkbox"
                                                                                        name="booking"
                                                                                        value="${s.slot_id} + sa"></td>
                                                                                <td><input type="checkbox"
                                                                                        name="booking"
                                                                                        value="${s.slot_id} + su"></td>
                                                                            </tr>
                                                                        </c:forEach>
                                                                ...
                                                                <div
                                                                    class="button-group d-flex pt-20 justify-content-md-end justify-content-start">
                                                                    <button type="submit" id="submitForm2"
                                                                        class="btn btn-primary btn-default btn-squared text-capitalize radius-md shadow2 btn-sm">OK</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
            ...
            <<<<<<< HEAD:build/web/mentor_info.jsp <script
                src="http://maps.googleapis.com/maps/api/js?key=AIzaSyBgYKHZB_QKKLWfIRaYPCadza3nhTAbv7c">
                </script>
