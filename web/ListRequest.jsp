                                                    ...
                                                    <div class="modal-content radius-xl">
                                                        <div class="modal-body pb-sm-50 pb-30">
                                                            ...
                                                            <div class="ticket_modal-modal">
                                                                ...
                                                                <div class="text-center">Deadline: ${request.deadlineHour} ${request.deadlineDate}</div><br>
                                                                    ...
                                                                    <table border="1" width="100%">
                                                                        ...
                                                                        <tbody>
                                                                            <c:forEach var="slot" items="${listSlots}" varStatus="loop">
                                                                                <tr>                                                                                 <td>
                                                                                        <c:choose>
                                                                                            <c:when test="${slot.slot_name == '7:00 - 9:00'}">
                                                                                                Slot 1
                                                                                            </c:when>
                                                                                            <c:when test="${slot.slot_name == '9:00 - 11:00'}">
                                                                                                Slot 2
                                                                                            </c:when>
                                                                                            <c:when test="${slot.slot_name == '13:00 - 15:00'}">
                                                                                                Slot 3
                                                                                            </c:when>
                                                                                            <c:when test="${slot.slot_name == '15:00 - 17:00'}">
                                                                                                Slot 4
                                                                                            </c:when>
                                                                                            <c:otherwise>
                                                                                                Invalid Slot
