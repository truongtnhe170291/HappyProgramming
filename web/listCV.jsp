                                            ...
                                            <tbody>
                                                <c:forEach items="${requestScope.cvList}" var="cv">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input id="rate_${cv.cvId}" required name="rate" value="${cv.rate}" class="userDatatable-content--date" type="text" />
                                                        </td>
                                                        <td>
                                                            <ul class="orderDatatable_actions mb-0 d-flex flex-wrap">
                                                                ...
                                                                <li>
                                                                    <form id="form_${cv.cvId}">
                                                                        ...
                                                                        <input id="rate_Input_${cv.cvId}" type="hidden" name="rate" value="" />
                                                                        <input id="mentor_" type="hidden" name="mentorName" value="${cv.userName}" />
                                                                    </form>
                                                                </li>
                                                                <li>
        ...
        document.addEventListener('DOMContentLoaded', (e) => {
            ...
            editButtons.forEach(button => {
                button.addEventListener('click', function(event) {
                    event.preventDefault();                     const cvId = this.id.split('_')[1];
                    const rate = document.getElementById('rate_' + cvId);
                    const rateInput = document.getElementById('rate_Input_' + cvId);
                    
                    rateInput.value = rate.value;
                    const form = document.getElementById('form_' + cvId);
                    form.action = 'changeStatus?cvId=' + cvId + '&status=2&rate=' + rate+'&mentorName=';
                    form.method = 'get';
                    form.submit();
                });
            });
